            ...
            <div className="card-body">
                ...
                <div className="d-flex justify-content-between">
                    <Link to={"/single/"+ props.id} className="card-link">
                        <button type="button" className="btn btn-outline-secondary border-dark border border-2 fw-bold">Learn more!</button>
                    </Link>
                    <Link className="card-link">
                        <button onClick={() => actions.addFav(props.nombre)}
                        type="button" className="btn btn-outline-dark"><i className="fa fa-heart"></i></button>
                    </Link>
                </div>
